    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between mt-4 mb-5 text-sm">
          ...
          <div className=" flex items-center text-xs text-gray-800 italic">
        ...
        <Link
          to={`/property/${val._id}`}
          className="mt-5 w-full bg-linear-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white font-semibold py-2.5 px-4 rounded-xl transition-all duration-300 shadow hover:shadow-lg"
        >
          View Details
        </Link>
      </div>
